...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/CORDIC_memoryC0_uid353_atan2Tables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC0_uid380_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC0_uid381_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC0_uid492_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC1_uid356_atan2Tables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC1_uid384_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC1_uid385_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC1_uid495_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC2_uid359_atan2Tables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC2_uid388_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/CORDIC_memoryC2_uid498_inverseTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/CORDIC.vo"
fi
